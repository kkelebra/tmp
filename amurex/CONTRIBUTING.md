...
First off, thank you for considering contributing to `amurex`. This guide details all the general information that one should know before contributing to the project.
...
```
git clone https://github.com/<YOUR_USER_NAME>/amurex.git
```
...
```
git remote add upstream https://github.com/thepersonalaicompany/amurex.git
```
...
**1.** On GitHub, navigate to the main page of the repository. [Here](https://github.com/thepersonalaicompany/amurex.git) in this case.
